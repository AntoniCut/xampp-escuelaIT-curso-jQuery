...
const headerTitle = 'Clase 16 - AJAX: Interfaz de alto nivel <br> 3 - Método GET enviando datos';
const scriptUrl = "/01-curso-jquery/src/scripts/16-ajax-interfaz-de-alto-nivel/03-get-ajax-datos.js";
