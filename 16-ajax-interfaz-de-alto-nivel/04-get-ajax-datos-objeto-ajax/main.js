...
const headerTitle = 'Clase 16 - AJAX: Interfaz de alto nivel <br> 4 - Método GET enviando datos con objeto AJAX';
const scriptUrl = "/01-curso-jquery/src/scripts/16-ajax-interfaz-de-alto-nivel/04-get-ajax-datos-objeto-ajax.js";
