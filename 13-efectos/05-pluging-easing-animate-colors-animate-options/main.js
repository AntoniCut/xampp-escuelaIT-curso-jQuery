/*
    ...
    ----------  /13-efectos/  -----------------------------------------------
    ----------  /05-plugin-easing-animate-colors-animate-options/  ----------
    ----------  /main.js  ---------------------------------------------------
    -------------------------------------------------------------------------
*/
...
const pluginEasing = "/01-curso-jquery/src/plugins/jquery.easing.1.3.min.js";
const pluginAnimateColors = "/01-curso-jquery/src/plugins/jquery.animate-colors-min.js";
const scriptUrl = "/01-curso-jquery/src/scripts/13-efectos/05-plugin-easing-animate-colors-animate-options.js";
...
loadJQueryByCdnOLocal(cdnJQuery, localJQuery)
    ...
    .then($ => {
        ...
        //  -----  cargamos el pluging 'jquery.easing.1.3.min.js'  -----
        loadScript(pluginEasing);

        //  -----  cargamos el pluging 'jquery.animate-colors.min.js'  -----
        loadScript(pluginAnimateColors);
