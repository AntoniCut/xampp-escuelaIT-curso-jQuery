/*  
    --------------------------------------------------------------------------
    ----------  /01-curso-jquery/  -------------------------------------------
    ----------  /02-es-necesario-utilizar-jquery-en-la-actualidad/  ----------
    ----------  /main.js  ----------------------------------------------------
    --------------------------------------------------------------------------  
*/
...
const headerTitle = 'Clase 2. ¿ Es necesario utilizar jQuery en la Actualidad ? <br> introduccion a jQuery y pdf de repaso de JavaScript - Parte 2';
